...
namespace DFTRK.Migrations
{
    ...
    [Migration("20250624182308_MakeWholesalerProductIdNullableInRetailerProduct")]
    partial class MakeWholesalerProductIdNullableInRetailerProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DFTRK.Models.RetailerPartnership", b =>
                {
                    ...
                    b.Property<string>("PartnershipName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("DFTRK.Models.RetailerPartnerCategory", b =>
                {
                    b.HasOne("DFTRK.Models.RetailerPartnership", "Partnership")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("DFTRK.Models.RetailerPartnerProduct", b =>
                {
                    b.HasOne("DFTRK.Models.RetailerPartnerCategory", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
